...
public:
  ...
  enum {
    ...
    RuleMove = 5, RulePrint = 6, RuleBlock = 7, RuleIfelse = 8, RuleIfelse_bis = 9, 
  ...
  class  BooleContext : public TypeContext {
  public:
    BooleContext(TypeContext *ctx);
  ...
  class  Ifelse_bisContext : public antlr4::ParserRuleContext {
  public:
  ...
  class  BoolorContext : public ExprContext {
  public:
    BoolorContext(ExprContext *ctx);
  ...
  class  InequalityContext : public ExprContext {
  public:
    InequalityContext(ExprContext *ctx);
  ...
  class  BoolandContext : public ExprContext {
  public:
    BoolandContext(ExprContext *ctx);
