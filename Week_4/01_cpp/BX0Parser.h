...
public:
  ...
  enum {
    RuleProgram = 0, RuleGlobalvar = 1, RuleGlobalvar_init = 2, RuleFunction = 3, 
    RuleProcedure = 4, RuleParameter_groups = 5, RuleParameter_group = 6, 
    RuleStmt = 7, RuleVardecl = 8, RuleVarinit = 9, RuleType = 10, RuleBlock = 11, 
    RuleExpress = 12, RuleMove = 13, RulePrint = 14, RuleIfelse = 15, RuleIfCont = 16, 
    RuleWhileLoop = 17, RuleReturnStmt = 18, RuleExpr = 19
  };
  ...
  class Globalvar_initContext;
  class FunctionContext;
  class ProcedureContext;
  class Parameter_groupsContext;
  class Parameter_groupContext;
  class StmtContext;
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<Globalvar_initContext *> globalvar_init();
    Globalvar_initContext* globalvar_init(size_t i);
    TypeContext *type();
  ...
  class  Globalvar_initContext : public antlr4::ParserRuleContext {
  public:
    Globalvar_initContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  Globalvar_initContext* globalvar_init();
  ...
  public:
    ...
    TypeContext *type();
    BlockContext *block();
    Parameter_groupsContext *parameter_groups();
  ...
  class  Parameter_groupsContext : public antlr4::ParserRuleContext {
  public:
    Parameter_groupsContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<Parameter_groupContext *> parameter_group();
    Parameter_groupContext* parameter_group(size_t i);
  ...
  class  Parameter_groupContext : public antlr4::ParserRuleContext {
  public:
    Parameter_groupContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  Parameter_groupContext* parameter_group();
  ...
  class  ExpressContext : public antlr4::ParserRuleContext {
  public:
    ExpressContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExprContext *expr();
  ...
  class  IfContContext : public antlr4::ParserRuleContext {
  public:
    IfContContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IfelseContext *ifelse();
    BlockContext *block();
  ...
  class  InequationContext : public ExprContext {
  public:
    InequationContext(ExprContext *ctx);
  ...
  class  EquationContext : public ExprContext {
  public:
    EquationContext(ExprContext *ctx);
